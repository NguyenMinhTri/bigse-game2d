...
#include "skill.h"
#include "SnakeMans.h"
class SnakeMens_Attack2 :
	public Skill
{
public:
	SnakeMans* m_SnakeMens;
	Sprite* m_SnakeMens_Attack2Sprite;
	Sprite* m_SnakeMens_Attack2_BallSprite;
	InfoSprite m_SnakeMens_Attack2InfoSprite;
	InfoSprite m_SnakeMens_Attack2_BallInfoSprite;
	bool m_TestBallFly;
	int m_VBallFly;
	SnakeMens_Attack2(SnakeMans* _SnakeMens);
	~SnakeMens_Attack2(void);
