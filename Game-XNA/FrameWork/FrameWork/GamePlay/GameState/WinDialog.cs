...
namespace FrameWork.GamePlay.GameState
{
    class WinDialog:iState
    {
        ...
        bool m_isTouchButton, m_isTouchNext, m_iEnd;
        ...
        public override void Render(GameTime gameTime, SpriteBatch _SpriteBatch)
        {
           ...
           _SpriteBatch.Begin(SpriteSortMode.Deferred,
            ...
            _SpriteBatch.DrawString(m_Font, "YOU WIN", new Vector2(380, 300), Color.Yellow, 0, Vector2.Zero, 2.0f, SpriteEffects.None, 1.0f);
            _SpriteBatch.DrawString(m_Font, "Your score: " +m_MainGame.SCORE, new Vector2(320,400), Color.Yellow, 0, Vector2.Zero, 2.0f, SpriteEffects.None, 1.0f);

            _SpriteBatch.DrawString(m_Font, "Your rate: " + m_Rate.ToString(), new Vector2(320, 450), Color.Red, 0, Vector2.Zero, 1.5f, SpriteEffects.None, 1.0f);
