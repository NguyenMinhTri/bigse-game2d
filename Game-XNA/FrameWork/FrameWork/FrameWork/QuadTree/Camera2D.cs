...
namespace FrameWork.FrameWork.QuadTree
{
    class Camera2D
    {
        ...
        Vector2 distance, distance1; //distance between pos camera and pos rect
        ...
        public Camera2D(Game _game, Rectangle _rect, Rectangle _viewRect)
        {
            Game = _game;
            CameraRect = _rect;
            viewRect = _viewRect;
            ...
            Distance1 = new Vector2(Pos.X - ViewRect.X, Pos.Y - ViewRect.Y);
            _Y = Pos.Y;
        }
        ...
        public void UpdateMove(MyObject Obj)
        {
            ...
            ViewRect = new Rectangle((int)(Pos.X - Distance1.X), (int)(Pos.Y - Distance1.Y), ViewRect.Width, ViewRect.Height);
        }
